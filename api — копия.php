...
$message = "Тип недвижимости: " . $_POST['nertype'] . "<br>"; 
$message = "Площадь: " . $_POST['send-result-polzunok'] . "<br>"; 
$message = "Площадь (не знает площадь): " . $_POST['no'] . "<br>"; 
$message = "Количество комнат: " . $_POST['orderRoof'] . "<br>"; 
$message = "Тип ремонта: " . $_POST['construction'] . "<br>"; 
$message = "Ремонт будем делать по дизайн-проекту? : " . $_POST['orderRoof22'] . "<br>"; 
$message = " Как скоро вам необходимо приступить к ремонту?: " . $_POST['orderRoof33'] . "<br>"; 
